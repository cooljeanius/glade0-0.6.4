...
GbWidget *gb_gnome_db_report_init ();
GbWidget *gb_gnome_db_iconlist_init ();
GbWidget *gb_gnome_db_designer_init ();
/*GbWidget *gb_gnome_db_entry_init ();*/
GbWidget *gb_gnome_db_export_init ();
/*GbWidget *gb_gnome_db_label_init ();*/
GbWidget *gb_gnome_db_log_viewer_init ();
GbWidget *gb_gnome_db_report_init ();
...
static GladeWidgetInitData gnome_db[] = {
	...
	{ "GnomeDbDesigner",	gb_gnome_db_designer_init },
	/*{ "GnomeDbEntry",	gb_gnome_db_entry_init },*/
	{ "GnomeDbExport",	gb_gnome_db_export_init },
	/*{ "GnomeDbLabel",	gb_gnome_db_label_init },*/
	{ "GnomeDbLogviewer",	gb_gnome_db_log_viewer_init },
