...
#include "../graphics/gnome-db-export.xpm"
 ...
 */
static GtkWidget*
gb_gnome_db_export_new (GbWidgetNewData *data)
{
  return gnome_db_export_new ();
}
...
/*
static void
gb_gnome_db_export_create_properties (GtkWidget * widget, GbWidgetCreateArgData * data)
{
...
/*
static void
gb_gnome_db_export_get_properties (GtkWidget *widget, GbWidgetGetArgData * data)
{
...
/*
static void
gb_gnome_db_export_set_properties (GtkWidget * widget, GbWidgetSetArgData * data)
{
...
/*
static void
gb_gnome_db_export_create_popup_menu (GtkWidget * widget, GbWidgetCreateMenuData * data)
{
 ...
 */
static void
gb_gnome_db_export_write_source (GtkWidget * widget, GbWidgetWriteSourceData * data)
{
  if (data->create_widget)
    {
      source_add (data, "  %s = gnome_db_export_new (NULL);\n", data->wname);
    }
